...
<style>
  .application-hero { padding: clamp(3.5rem, 8vw, 7rem) 0; border-bottom: 1px solid var(--line); background: var(--paper-deep); }
  ...
  fieldset{display:grid;gap:.7rem;margin:1.5rem;padding:1.2rem;border:1px solid var(--line);border-radius:8px}legend{padding:0 .4rem;font-weight:700}fieldset label{display:grid;min-height:44px;align-items:center;grid-template-columns:18px 24px 1fr;gap:.5rem;color:var(--ink-soft);font-size:.75rem}fieldset input{width:18px;height:18px;accent-color:var(--action)}fieldset label>span{display:none}
